...
APIS_B = [
    {"name": "MBC",   "url": "https://mbcs-ms.com/crapi/mbc/viewstats",     "token": "fzLw2WJUMJWFGMyE6Ks35sG0b2etKq4CdQHqs"},
...
async def handle_callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── Numbers flow ──
        ...
        await query.edit_message_text(
            ...
            "    🌍 <b>SELECT COUNTRY</b>\n"
            "╚═══════════════════════╝\n\n"
            "<i>Don't see your country? Just type it!</i>\n"
            "<i>Example: </i><code>Tanzania</code>",
        ...
        await query.edit_message_text(
            ...
            f"<i>Don't see your service? Just type it!</i>\n"
...
async def handle_menu(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── Typed country (check FIRST before anything else) ──
    ...
    # ── Typed service (check FIRST before anything else) ──
