...
APIS_A = [
    ...
    {"name": "GAZA",  "url": "http://147.135.212.197/crapi/had/viewstats",                                              "token": "R1JXQjRSQlVFbpFJQlZXfXZuckJmiZeIg5BUeXyKU4qCYVFDenFy"},           # ← Add URL + token when ready
]
# Format B — uses dt1/dt2 + num/cli fields
APIS_B = [
    {"name": "MBC",   "url": "https://mbcs-ms.com/crapi/mbc/viewstats",     "token": "fzLD7w2WJUMJWFGMyE6Ks35sG0b2etKq4CdQHqs"},
